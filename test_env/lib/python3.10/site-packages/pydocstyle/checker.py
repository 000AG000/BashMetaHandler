...
from .parser import NestedClass
from .parser import NestedFunction
from .parser import Package
from .parser import ParseError
from .parser import Parser
from .parser import StringIO
from .utils import common_prefix_length
from .utils import is_blank
from .utils import log
from .utils import pairwise
from .utils import strip_non_alphanumeric
from .wordlists import IMPERATIVE_BLACKLIST
from .wordlists import IMPERATIVE_VERBS
from .wordlists import stem
    ...
    def check_docstring_missing(self, definition, docstring):
        ...
        def method_violation():
            ...
            if definition.is_init:
                if self.ignore_self_only_init and len(definition.param_names) == 1:
                    return None
