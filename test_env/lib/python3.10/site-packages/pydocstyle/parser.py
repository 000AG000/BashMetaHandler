...
class UnexpectedTokenError(ParseError):
    ...
    def __str__(self):
        return f"Unexpected token {self.token}, expected {self.expected_kind}"
...
class Function(Definition):
    ...
    def is_overload(self):
        ...
        return any(decorator.name == "overload" for decorator in self.decorators)

    def is_property(self, property_decorator_names):
        """Return True if the method is decorated with any property decorator."""
        return any(
            decorator.name in property_decorator_names for decorator in self.decorators
        )
