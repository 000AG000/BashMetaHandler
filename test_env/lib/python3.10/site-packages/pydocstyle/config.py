...
from .violations import conventions
...
class ConfigurationParser:
    ...
    def _merge_configuration(self, parent_config, child_options):
        ...
        for key in (
            ...
            kwargs[key] = (
                child_value if child_value is not None else getattr(parent_config, key)
            )
    ...
    def _create_option_parser(cls):
        ...
        option(
            ...
            help=(
                ...
                "is --property-decorators='{}'".format(cls.DEFAULT_PROPERTY_DECORATORS)
            ),
        )
