...
from ._check_module import ArgcompleteMarkerNotFound
from ._check_module import find
...
def main():
    ...
    entry_points = [
        ep for ep in entry_points if ep.name == name and ep.group == "console_scripts"
    ]  # type:ignore
