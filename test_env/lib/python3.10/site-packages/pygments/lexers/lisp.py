...
from pygments.lexers._scheme_builtins import scheme_builtins
from pygments.lexers._scheme_builtins import scheme_keywords
...
class RacketLexer(RegexLexer):
    ...
    _inexact_normal_no_hashes = r"(?:{}{}?)".format(_inexact_simple_no_hashes, _exponent)
    _inexact_normal = r"(?:{}{}?)".format(_inexact_simple, _exponent)
    _inexact_special = r"(?:(?:inf|nan)\.[0f])"
    _inexact_real = r"(?:[-+]?{}|[-+]{})".format(_inexact_normal, _inexact_special)
