...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "declarations": [
            (
                fr"\b(def)\b(\s*){notStartOfComment}({anyId})?",
                bygroups(Keyword, Whitespace, Name.Function),
            ),
            (
                fr"\b(trait)\b(\s*){notStartOfComment}({anyId})?",
            ...
            (
                fr"(?<!\.)\b(type)\b(\s*){notStartOfComment}({anyId})?",
                bygroups(Keyword, Whitespace, Name.Class),
            ),
            (r"\b(val|var)\b", Keyword.Declaration),
            (
                r"\b(package)(\s+)(object)\b(\s*){}({})?".format(
                    notStartOfComment, anyId
                ),
        ...
        "end": [
            ...
            (
                fr"\b(end)(\s+)({idUpper}){endOfLineMaybeWithComment}",
                bygroups(Keyword, Whitespace, Name.Class),
            ),
            (
                r"\b(end)(\s+)(%s|%s)?%s"
        ...
        "inline": [
            ...
            # match or parameters.
            (fr"\b(inline)(?=\s+({plainid}|{backQuotedId})\s*:)", Keyword),
