...
try:
    ...
    from pydantic import Field
    from pydantic import root_validator as model_validator  # type: ignore # noqa F401 # pragma: no cover

    MODEL_VALIDATOR_KWARGS = {}
    LATEST_PYDANTIC = False

from .constants import BRANCH_DESC
from .constants import OS_DESCRIPTION_DESC
from .constants import OS_RELEASE_DESC
from .constants import OS_TYPE_DESC
from .constants import PYTHON_VERSION_DESC
from .constants import SAFETY_COMMAND_DESC
from .constants import SAFETY_OPTIONS_DESC
from .constants import SAFETY_SOURCE_DESC
from .constants import SAFETY_VERSION_DESC
from .constants import TAG_DESC
...
class Telemetry(SchemaModelV30):
    ...
    os_type: Annotated[
        str | None, Field(description=OS_TYPE_DESC, examples=["Darwin", "Linux", ""])
    ] = None
    ...
    python_version: Annotated[
        str | None, Field(description=PYTHON_VERSION_DESC, examples=["3.11.1"])
    ] = None
...
class Remediation(BaseModel):
    ...
    closest_secure: Annotated[
        ClosestSecureSpecification | None, Field(alias="closest_secure_version")
    ] = None
...
class Results(BaseModel):
    dependencies: list[Package | FullPackage] = []
...
class Meta(SchemaModelV30):
    ...
    authentication_method: Annotated[AuthenticationMethod | None, Field()]
    timestamp: Annotated[
        datetime,
...
class ScanResults(BaseModel):
    ...
    projects: Annotated[
        list[Projects] | list[ProjectsScan],
        Field(
            ...,
