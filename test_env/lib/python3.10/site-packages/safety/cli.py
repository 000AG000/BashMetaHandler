...
from safety.auth import auth_options
from safety.auth import inject_session
from safety.auth import proxy_options
from safety.auth.cli import auth_app
from safety.auth.models import Organization
from safety.console import main_console as console
from safety.constants import CONFIG_FILE_SYSTEM
from safety.constants import CONFIG_FILE_USER
from safety.constants import EXIT_CODE_FAILURE
from safety.constants import EXIT_CODE_OK
...
from safety.safety import get_packages
from safety.safety import process_fixes
from safety.safety import read_vulnerabilities
from safety.scan.command import scan_project_app
from safety.scan.command import scan_system_app
from safety.scan.constants import CLI_CHECK_COMMAND_HELP
from safety.scan.constants import CLI_CHECK_UPDATES_HELP
from safety.scan.constants import CLI_CONFIGURE_HELP
from safety.scan.constants import CLI_CONFIGURE_ORGANIZATION_ID
from safety.scan.constants import CLI_CONFIGURE_ORGANIZATION_NAME
from safety.scan.constants import CLI_CONFIGURE_PROXY_HOST_HELP
from safety.scan.constants import CLI_CONFIGURE_PROXY_PORT_HELP
from safety.scan.constants import CLI_CONFIGURE_PROXY_PROTOCOL_HELP
from safety.scan.constants import CLI_CONFIGURE_PROXY_REQUIRED
from safety.scan.constants import CLI_CONFIGURE_PROXY_TIMEOUT
from safety.scan.constants import CLI_CONFIGURE_SAVE_TO_SYSTEM
from safety.scan.constants import CLI_DEBUG_HELP
from safety.scan.constants import CLI_DISABLE_OPTIONAL_TELEMETRY_DATA_HELP
from safety.scan.constants import CLI_GENERATE_HELP
from safety.scan.constants import CLI_GENERATE_PATH
from safety.scan.constants import CLI_LICENSES_COMMAND_HELP
from safety.scan.constants import CLI_MAIN_INTRODUCTION
from safety.scan.constants import DEFAULT_EPILOG
from safety.scan.constants import DEFAULT_SPINNER
from safety.util import DependentOption
from safety.util import MutuallyExclusiveOption
from safety.util import SafetyContext
from safety.util import SafetyPolicyFile
from safety.util import active_color_if_needed
from safety.util import bare_alias
from safety.util import filter_announcements
from safety.util import get_fix_options
from safety.util import get_packages_licenses
from safety.util import get_processed_options
from safety.util import get_safety_version
from safety.util import html_alias
from safety.util import initializate_config_dirs
from safety.util import is_a_remote_mirror
from safety.util import json_alias
from safety.util import output_exception
from safety.util import transform_ignore
from safety_schemas.models import ConfigModel
from safety_schemas.models import Stage

from .cli_util import SafetyCLICommand
from .cli_util import SafetyCLILegacyCommand
from .cli_util import SafetyCLILegacyGroup
from .cli_util import SafetyCLISubGroup
from .cli_util import SafetyCLIUtilityCommand
...
def clean_check_command(f):
    ...
    def inner(ctx, *args, **kwargs):
        ...
        try:
            ...
            policy_file, server_audit_and_monitor = safety.get_server_policies(
...
@cli.command(
    cls=SafetyCLILegacyCommand, utility_command=True, help=CLI_CHECK_COMMAND_HELP
)
@proxy_options
...
def check(
    ...
    try:
        ...
        announcements.extend(
            safety.add_local_notifications(packages, ignore_unpinned_requirements)
        )
...
@cli.command(
    cls=SafetyCLILegacyCommand, utility_command=True, help=CLI_LICENSES_COMMAND_HELP
)
@proxy_options
@auth_options(stage=False)
@click.option(
...
@cli.command(cls=SafetyCLILegacyCommand, help=CLI_CONFIGURE_HELP, utility_command=True)
@click.option(
    "--proxy-protocol",
    "-pr",
