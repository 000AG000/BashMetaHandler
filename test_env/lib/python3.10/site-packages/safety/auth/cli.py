...
from safety.constants import MSG_FINISH_REGISTRATION_TPL
from safety.constants import MSG_VERIFICATION_HINT
...
from safety.auth.main import clean_session
from safety.auth.main import get_auth_info
from safety.auth.main import get_authorization_data
from safety.auth.main import get_token
from safety.auth.server import process_browser_callback
from safety.scan.constants import CLI_AUTH_COMMAND_HELP
from safety.scan.constants import CLI_AUTH_LOGIN_HELP
from safety.scan.constants import CLI_AUTH_LOGOUT_HELP
from safety.scan.constants import CLI_AUTH_STATUS_HELP
...
from ..cli_util import pass_safety_cli_obj
from .constants import MSG_FAIL_LOGIN_AUTHED
from .constants import MSG_FAIL_REGISTER_AUTHED
from .constants import MSG_LOGOUT_DONE
from .constants import MSG_LOGOUT_FAILED
from .constants import MSG_NON_AUTHENTICATED
...
def render_successful_login(auth: Auth, organization: Optional[str] = None) -> None:
    ...
    if organization:
        details.insert(0, "[green][bold]Organization:[/bold] " f"{organization}[green]")
...
@click.option(
    ...
    default=False,
    help="This will keep running the command until an" "authentication is made.",
)
@click.option(
    "--login-timeout",
    "-w",
