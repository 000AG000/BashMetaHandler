...
from safety.auth.constants import AUTH_CONFIG_USER
from safety.auth.constants import CLI_AUTH
from safety.auth.constants import CLI_AUTH_LOGOUT
from safety.auth.constants import CLI_CALLBACK
    ...
    if ctx.obj.auth.client.token:
        try:
            ...
            try:
                ...
                info = get_token_data(
                    get_token(name="id_token"), keys=ctx.obj.auth.keys
                )
