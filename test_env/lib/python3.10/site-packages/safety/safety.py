...
from .constants import API_MIRRORS
from .constants import DATA_API_BASE_URL
from .constants import DB_CACHE_FILE
from .constants import IGNORE_UNPINNED_REQ_REASON
from .constants import JSON_SCHEMA_VERSION
from .constants import OPEN_MIRRORS
from .constants import REQUEST_TIMEOUT
from .errors import DatabaseFetchError
from .errors import DatabaseFileNotFoundError
from .errors import InvalidCredentialError
from .errors import MalformedDatabase
from .errors import NetworkConnectionError
from .errors import RequestTimeoutError
from .errors import ServerError
from .errors import TooManyRequestsError
from .models import CVE
from .models import Fix
from .models import SafetyRequirement
from .models import Severity
from .models import Vulnerability
from .models import is_pinned_requirement
from .output_utils import get_applied_msg
from .output_utils import get_fix_opt_used_msg
from .output_utils import get_skipped_msg
from .output_utils import get_specifier_range_info
from .output_utils import is_using_api_key
from .output_utils import print_service
from .output_utils import prompt_service
from .util import Package
from .util import SafetyContext
from .util import SafetyPolicyFile
from .util import build_remediation_info_url
from .util import build_telemetry_data
from .util import get_hashes
from .util import get_requirements_content
from .util import get_terminal_size
from .util import is_a_remote_mirror
from .util import is_ignore_unpinned_mode
from .util import pluralize
from .util import read_requirements
from .util import sync_safety_context
from .util import validate_expiration_date
...
def post_results(
    session: requests.Session, safety_json: str, policy_file: str
) -> Dict[str, Any]:
    """
...
def ignore_vuln_if_needed(
    ...
    if severity:
        if float(severity) < ignore_severity_below:
            reason = "Ignored by severity rule in policy file, {} < {}".format(
...
def process_fixes_scan(
    ...
    def get_remmediation_from(spec):
        ...
        try:
            ...
            LOG.error(
                f"Error getting upper remediation version, ignoring", exc_info=True
            )
        ...
        try:
            ...
            LOG.error(
                f"Error getting lower remediation version, ignoring", exc_info=True
            )
        ...
        try:
            ...
            LOG.error(
                f"Error getting recommended version for remediation, ignoring",
                exc_info=True,
            )
...
def compute_fixes_per_requirements(
    ...
    from dparse.parser import filetypes
...
def find_vulnerabilities_fixed(
    ...
    """
    fixed_specs = {fix.previous_spec for fix in fixes}
