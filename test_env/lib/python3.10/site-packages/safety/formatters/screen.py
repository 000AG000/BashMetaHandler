...
from safety.output_utils import add_empty_line
from safety.output_utils import build_announcements_section_content
from safety.output_utils import build_primary_announcement
from safety.output_utils import build_remediation_section
from safety.output_utils import build_report_brief_section
from safety.output_utils import format_license
from safety.output_utils import format_long_text
from safety.output_utils import format_unpinned_vulnerabilities
from safety.output_utils import format_vulnerability
from safety.output_utils import get_final_brief
from safety.output_utils import get_final_brief_license
from safety.output_utils import get_specifier_range_info
from safety.util import get_basic_announcements
from safety.util import get_primary_announcement
from safety.util import get_terminal_size
from safety.util import is_ignore_unpinned_mode
...
"""
    ...
    def render_licenses(self, announcements: List[Dict], licenses: List[Dict]) -> str:
        ...
        """
        unique_license_types = {lic["license"] for lic in licenses}
