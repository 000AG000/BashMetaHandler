...
from safety.constants import SAFETY_POLICY_FILE_NAME
from safety.constants import SYSTEM_CONFIG_DIR
from safety.constants import SYSTEM_POLICY_FILE
from safety.constants import USER_POLICY_FILE
...
from safety.scan.main import PROJECT_CONFIG
...
from safety.scan.main import resolve_policy
from safety.scan.models import ScanOutput
from safety.scan.models import SystemScanOutput
from safety.scan.render import print_announcements
from safety.scan.render import print_header
from safety.scan.render import print_project_info
from safety.scan.render import print_wait_policy_download
...
from safety_schemas.models import MetadataModel
from safety_schemas.models import PolicySource
from safety_schemas.models import ProjectModel
from safety_schemas.models import ReportSchemaVersion
        ...
        **kwargs,
        ...
        if ctx.obj.project.policy:
            if ctx.obj.project.policy.source is PolicySource.cloud:
                msg = (
                    f"fetched from Safety Platform, "
