...
CLI_MAIN_INTRODUCTION = (
    f"[bold]Safety CLI 3 - Vulnerability Scanning for Secure Python Development[/bold]\n\n"
...
CLI_CHECK_COMMAND_HELP = (
    "\\[deprecated] Find vulnerabilities at target files or enviroments. Now replaced by [bold]safety scan[/bold], and will be unsupported beyond 1 May 2024."
    "\n[bold]Example: safety check -r requirements.txt[/bold]"
)
CLI_LICENSES_COMMAND_HELP = (
    "\\[deprecated] Find licenses at target files or enviroments. This command will be replaced by [bold]safety scan[/bold], and will be unsupported beyond 1 May 2024."
