...
from git.types import TypedDict
...
from .fun import find_submodule_git_dir
from .fun import find_worktree_git_dir
from .fun import is_git_dir
from .fun import rev_parse
from .fun import touch
...
class Repo:
    ...
    * :attr:`git_dir` is the ``.git`` repository directory, which is always set.
    ...
    def __repr__(self) -> str:
        ...
        return f"<{clazz.__module__}.{clazz.__name__} {self.git_dir!r}>"
