...
from .util import TraversableIterableObj
from .util import altz_to_utctz_str
from .util import from_timestamp
from .util import parse_actor_and_date
    ...
    def stats(self) -> Stats:
        ...
        if not self.parents:
            ...
            for line in text.splitlines()[1:]:
                ...
                text2 += f"{insertions}\t{deletions}\t{filename}\n"
            text = text2
        else:
