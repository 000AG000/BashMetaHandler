...
from .base import IndexObjUnion
from .blob import Blob
from .fun import tree_entries_from_data
from .fun import tree_to_stream
    ...
    def _iter_convert_to_object(
        ...
        for binsha, mode, name in iterable:
            ...
            try:
                ...
                raise TypeError(
                    "Unknown mode {:o} found in tree data for path '{}'".format(mode, path)
                ) from e
        # END for each item
