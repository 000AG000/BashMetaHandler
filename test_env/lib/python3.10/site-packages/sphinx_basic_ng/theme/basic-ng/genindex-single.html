{# Module: single page index, split by a "key" #} {% extends "page.html" %} {%
block head_title -%} {{ _("Index") }} - {{ docstitle|striptags|e }} {%- endblock
head_title %} {% macro indexentries(firstname, links) -%} {% if links -%}
<a href="{{ links[0][1] }}">
  {%- if links[0][0] %}<strong
...
<div class="sb-article-container">
  <article role="main">
    ...
    <section class="genindex-section">
      <h1 id="index">
        {% trans key=key %}Index &ndash; {{ key }}{% endtrans %}
      </h1>
    </section>
