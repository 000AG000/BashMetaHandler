...
from ._meta import __copyright__
from ._meta import __credits__
from ._meta import __license__
...
from .util import RecursionError
from .util import iter_tree
from .util import lookup_pattern
