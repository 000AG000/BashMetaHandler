                ...
                try:
                    ...
                    if data__packages_is_list:
                        ...
                        for data__packages_x, data__packages_item in enumerate(data__packages):
                            validate_https___setuptools_pypa_io_en_latest_references_keywords_html__definitions_package_name(data__packages_item, custom_formats, (name_prefix or "data") + f".packages[{data__packages_x}]")
                    ...
                    if data__dynamic__optionaldependencies_is_dict:
                        ...
                        for data__dynamic__optionaldependencies_key, data__dynamic__optionaldependencies_val in data__dynamic__optionaldependencies.items():
                            if REGEX_PATTERNS['.+'].search(data__dynamic__optionaldependencies_key):
                                ...
                                validate_https___setuptools_pypa_io_en_latest_references_keywords_html__definitions_file_directive(data__dynamic__optionaldependencies_val, custom_formats, (name_prefix or "data") + f".dynamic.optional-dependencies.{data__dynamic__optionaldependencies_key}")
        ...
        if "authors" in data_keys:
            ...
            if data__authors_is_list:
                ...
                for data__authors_x, data__authors_item in enumerate(data__authors):
                    validate_https___packaging_python_org_en_latest_specifications_declaring_project_metadata___definitions_author(data__authors_item, custom_formats, (name_prefix or "data") + f".authors[{data__authors_x}]")
        if "maintainers" in data_keys:
            ...
            if data__maintainers_is_list:
                ...
                for data__maintainers_x, data__maintainers_item in enumerate(data__maintainers):
                    validate_https___packaging_python_org_en_latest_specifications_declaring_project_metadata___definitions_author(data__maintainers_item, custom_formats, (name_prefix or "data") + f".maintainers[{data__maintainers_x}]")
            ...
            if data__entrypoints_is_dict:
                ...
                for data__entrypoints_key, data__entrypoints_val in data__entrypoints.items():
                    if REGEX_PATTERNS['^.+$'].search(data__entrypoints_key):
                        ...
                        validate_https___packaging_python_org_en_latest_specifications_declaring_project_metadata___definitions_entry_point_group(data__entrypoints_val, custom_formats, (name_prefix or "data") + f".entry-points.{data__entrypoints_key}")
        ...
        if "dependencies" in data_keys:
            ...
            if data__dependencies_is_list:
                ...
                for data__dependencies_x, data__dependencies_item in enumerate(data__dependencies):
                    validate_https___packaging_python_org_en_latest_specifications_declaring_project_metadata___definitions_dependency(data__dependencies_item, custom_formats, (name_prefix or "data") + f".dependencies[{data__dependencies_x}]")
                    ...
                    if REGEX_PATTERNS['^.+$'].search(data__optionaldependencies_key):
                        ...
                        if data__optionaldependencies_val_is_list:
                            ...
                            for data__optionaldependencies_val_x, data__optionaldependencies_val_item in enumerate(data__optionaldependencies_val):
                                validate_https___packaging_python_org_en_latest_specifications_declaring_project_metadata___definitions_dependency(data__optionaldependencies_val_item, custom_formats, (name_prefix or "data") + f".optional-dependencies.{data__optionaldependencies_key}[{data__optionaldependencies_val_x}]")
