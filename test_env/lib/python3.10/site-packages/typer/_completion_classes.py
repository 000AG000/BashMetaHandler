...
from ._completion_shared import COMPLETION_SCRIPT_FISH
from ._completion_shared import COMPLETION_SCRIPT_POWER_SHELL
from ._completion_shared import COMPLETION_SCRIPT_ZSH
