...
def wmic(path, what, converter=int):
    ...
    2134124534
    """
    out = sh("wmic path {} get {}".format(path, what)).strip()
...
class TestSystemAPIs(WindowsTestCase):
            ...
            for wmi_part in wmi_parts:
                if ps_part.device.replace("\\", "") == wmi_part.DeviceID:
                    ...
                    if abs(usage.free - wmi_free) > 10 * 1024 * 1024:
                        raise self.fail("psutil={}, wmi={}".format(usage.free, wmi_free))
                    break
            else:
    ...
    def test_net_if_stats(self):
        ...
        self.assertTrue(
            ps_names & wmi_names,
            "no common entries in {}, {}".format(ps_names, wmi_names),
        )
...
class TestProcessWMI(WindowsTestCase):
    ...
    def test_memory_vms(self):
        ...
        if vms not in (wmi_usage, wmi_usage * 1024):
            raise self.fail("wmi={}, psutil={}".format(wmi_usage, vms))
