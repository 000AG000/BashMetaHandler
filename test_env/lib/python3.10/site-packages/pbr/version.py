        ...
        if remainder_starts_with_int:
            ...
            while remainder:
                ...
                if component.startswith("dev"):
                    ...
                    raise ValueError(
                        "Unknown remainder {!r} in {!r}".format(remainder, version_string)
                    )
                remainder = remainder[1:]
...
class VersionInfo:
    ...
    def __repr__(self):
        """Include the name."""
        return "pbr.version.VersionInfo({}:{})".format(self.package, self.version_string())
    ...
    def cached_version_string(self, prefix=""):
        ...
        if not self._cached_version:
            self._cached_version = "{}{}".format(prefix, self.version_string())
