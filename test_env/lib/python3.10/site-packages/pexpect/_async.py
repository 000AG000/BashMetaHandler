...
if py_version_info >= (3, 6):
    from pexpect._async_w_await import PatternWaiter
    from pexpect._async_w_await import expect_async
    from pexpect._async_w_await import repl_run_command_async
else:
    from pexpect._async_pre_await import PatternWaiter
    from pexpect._async_pre_await import expect_async
    from pexpect._async_pre_await import repl_run_command_async
