...
class Recompiler:
    ...
    def write_c_source_to_f(self, f, preamble):
        ...
        if self.ffi._embedding is not None:
            ...
            prnt("# define _CFFI_PYTHON_STARTUP_FUNC  PyInit_{}".format(base_module_name))
            prnt("#else")
    ...
    def _convert_expr_from_c(self, tp, var, context):
        if isinstance(tp, model.BasePrimitiveType):
            ...
            if tp.fldnames is None:
                raise TypeError(
                    "'{}' is used as {}, but is opaque".format(tp._get_c_name(), context)
                )
    ...
    def _struct_ctx(self, tp, cname, approxname, named_ptr=None):
        ...
        if reason_for_not_expanding is None:
            ...
            for fldname, fldtype, fbitsize, fqual in enumfields:
                ...
                self._check_not_opaque(fldtype, "field '{}.{}'".format(tp.name, fldname))
    ...
    def _extern_python_decl(self, tp, name, tag_and_space):
        ...
        prnt('  {{ "{}.{}", {}, 0, 0 }};'.format(self.module_name, name, size_of_result))
        prnt()
        #
        arguments = []
        context = "argument of %s" % name
