...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta
      name="generator"
      content="Docutils 0.17b.dev: http://docutils.sourceforge.net/"
    />
    <title>SOURCES.txt</title>
    <link
      rel="stylesheet"
      href="../docutils/writers/html4css1/html4css1.css"
      type="text/css"
    />
  </head>
  <body>
    <div class="document">
      <p>
        BUGS.txt COPYING.txt FAQ.txt HISTORY.txt MANIFEST MANIFEST.in README.txt
        RELEASE-NOTES.txt THANKS.txt install.py setup.cfg setup.py
        docs/index.txt docs/api/cmdline-tool.txt docs/api/publisher.txt
        docs/api/runtime-settings.txt docs/dev/distributing.txt
        docs/dev/enthought-plan.txt docs/dev/enthought-rfp.txt
        docs/dev/hacking.txt docs/dev/policies.txt docs/dev/pysource.dtd
        docs/dev/pysource.txt docs/dev/release.txt docs/dev/repository.txt
        docs/dev/semantics.txt docs/dev/testing.txt docs/dev/todo.txt
        docs/dev/website.txt docs/dev/rst/alternatives.txt
        docs/dev/rst/problems.txt docs/howto/html-stylesheets.txt
        docs/howto/i18n.txt docs/howto/rst-directives.txt
        docs/howto/rst-roles.txt docs/howto/security.txt docs/peps/pep-0256.txt
        docs/peps/pep-0257.txt docs/peps/pep-0258.txt docs/peps/pep-0287.txt
        docs/ref/doctree.txt docs/ref/docutils.dtd docs/ref/soextblx.dtd
        docs/ref/transforms.txt docs/ref/rst/definitions.txt
        docs/ref/rst/directives.txt docs/ref/rst/introduction.txt
        docs/ref/rst/restructuredtext.txt docs/ref/rst/roles.txt
        docs/user/Makefile.docutils-update docs/user/config.txt
        docs/user/emacs.txt docs/user/html.txt docs/user/latex.txt
        docs/user/links.txt docs/user/mailing-lists.txt docs/user/manpage.txt
        docs/user/odt.txt docs/user/slide-shows.txt docs/user/smartquotes.txt
        docs/user/tools.txt docs/user/images/big-black.png
        docs/user/images/big-white.png docs/user/images/default.png
        docs/user/images/happy_monkey.png docs/user/images/medium-black.png
        docs/user/images/medium-white.png docs/user/images/rsp-all.png
        docs/user/images/rsp-breaks.png docs/user/images/rsp-covers.png
        docs/user/images/rsp-cuts.png docs/user/images/rsp-empty.png
        docs/user/images/rsp-objects.png docs/user/images/rsp.svg
        docs/user/images/s5-files.png docs/user/images/s5-files.svg
        docs/user/images/small-black.png docs/user/images/small-white.png
        docs/user/rst/cheatsheet.txt docs/user/rst/demo.txt
        docs/user/rst/quickref.html docs/user/rst/quickstart.txt
        ...
        docs/user/rst/images/biohazard.png docs/user/rst/images/biohazard.svg
        docs/user/rst/images/biohazard.swf
        docs/user/rst/images/title-scaling.svg docs/user/rst/images/title.png
        docs/user/rst/images/title.svg docutils/__init__.py docutils/core.py
        docutils/docutils.conf docutils/examples.py docutils/frontend.py
        docutils/io.py docutils/nodes.py docutils/statemachine.py
        docutils.egg-info/PKG-INFO docutils.egg-info/SOURCES.txt
        docutils.egg-info/dependency_links.txt docutils.egg-info/top_level.txt
        docutils/languages/__init__.py docutils/languages/af.py
        docutils/languages/ca.py docutils/languages/cs.py
        docutils/languages/da.py docutils/languages/de.py
        docutils/languages/en.py docutils/languages/eo.py
        docutils/languages/es.py docutils/languages/fa.py
        docutils/languages/fi.py docutils/languages/fr.py
        docutils/languages/gl.py docutils/languages/he.py
        docutils/languages/it.py docutils/languages/ja.py
        docutils/languages/ko.py docutils/languages/lt.py
        docutils/languages/lv.py docutils/languages/nl.py
        docutils/languages/pl.py docutils/languages/pt_br.py
        docutils/languages/ru.py docutils/languages/sk.py
        docutils/languages/sv.py docutils/languages/zh_cn.py
        docutils/languages/zh_tw.py docutils/parsers/__init__.py
        docutils/parsers/null.py docutils/parsers/rst/__init__.py
        docutils/parsers/rst/roles.py docutils/parsers/rst/states.py
        ...
        docutils/parsers/rst/languages/zh_tw.py docutils/readers/__init__.py
        docutils/readers/doctree.py docutils/readers/pep.py
        docutils/readers/standalone.py docutils/transforms/__init__.py
        docutils/transforms/components.py docutils/transforms/frontmatter.py
        docutils/transforms/misc.py docutils/transforms/parts.py
        docutils/transforms/peps.py docutils/transforms/references.py
        docutils/transforms/universal.py docutils/transforms/writer_aux.py
        docutils/utils/.smartquotes.py.swp docutils/utils/__init__.py
        docutils/utils/code_analyzer.py docutils/utils/error_reporting.py
        docutils/utils/punctuation_chars.py docutils/utils/roman.py
        docutils/utils/smartquotes.py docutils/utils/urischemes.py
        docutils/utils/math/__init__.py docutils/utils/math/latex2mathml.py
        docutils/utils/math/math2html.py
        docutils/utils/math/tex2mathml_extern.py
        docutils/utils/math/tex2unichar.py docutils/utils/math/unichar2tex.py
        docutils/writers/__init__.py docutils/writers/_html_base.py
        docutils/writers/docutils_xml.py docutils/writers/manpage.py
        docutils/writers/null.py docutils/writers/pseudoxml.py
        ...
        docutils/writers/pep_html/__init__.py docutils/writers/pep_html/pep.css
        ...
        docutils/writers/xetex/__init__.py licenses/BSD-2-Clause.txt
        licenses/docutils.conf licenses/gpl-3-0.txt licenses/python-2-1-1.txt
        test/DocutilsTestSupport.py test/alltests.py test/coverage.sh
        test/docutils.conf test/local-parser.py test/local-reader.py
        test/local-writer.py test/local_dummy_lang.py test/package_unittest.py
        test/test__init__.py test/test_command_line.py test/test_dependencies.py
        test/test_error_reporting.py test/test_functional.py test/test_io.py
        test/test_language.py test/test_nodes.py test/test_pickle.py
        test/test_publisher.py test/test_settings.py test/test_statemachine.py
        test/test_traversals.py test/test_utils.py test/test_viewlist.py
        test/data/config_1.txt test/data/config_2.txt
        test/data/config_error_handler.txt test/data/config_list.txt
        test/data/config_list_2.txt test/data/config_old.txt
        test/data/csv_data.txt test/data/csv_dep.txt test/data/dependencies.txt
        test/data/full-template.txt test/data/ham.css test/data/ham.tex
        test/data/include.txt test/data/latin1.txt test/data/raw.txt
        test/data/stylesheet.txt test/functional/README.txt
        ...
        test/functional/input/cyrillic.txt test/functional/input/dangerous.txt
        test/functional/input/field_list.txt test/functional/input/footnotes.txt
        ...
        test/functional/input/odt_no_class.txt test/functional/input/odt_raw.txt
        test/functional/input/odt_tables1.txt
        test/functional/input/odt_unnested_class.txt
        test/functional/input/pep_html.txt test/functional/input/simple.txt
        ...
        test/functional/input/data/math.css test/functional/input/data/math.txt
        ...
        test/functional/input/data/urls.txt test/functional/output/README.txt
        ...
        test/functional/tests/xetex_cyrillic.py test/test_parsers/__init__.py
        test/test_parsers/test_get_parser_class.py
        test/test_parsers/test_parser.py test/test_parsers/test_rst/__init__.py
        ...
        test/test_readers/__init__.py test/test_readers/test_get_reader_class.py
        ...
        test/test_transforms/__init__.py test/test_transforms/test___init__.py
        test/test_transforms/test_class.py test/test_transforms/test_contents.py
        ...
        test/test_transforms/test_messages.py test/test_transforms/test_peps.py
        ...
        test/test_transforms/test_writer_aux.py test/test_writers/__init__.py
        ...
        test/test_writers/test_latex2e.py test/test_writers/test_manpage.py
        test/test_writers/test_null.py test/test_writers/test_odt.py
        test/test_writers/test_pseudoxml.py test/test_writers/test_s5.py
        tools/buildhtml.py tools/docutils.conf tools/quicktest.py
        tools/rst2html.py tools/rst2html4.py tools/rst2html5.py
        tools/rst2latex.py tools/rst2man.py tools/rst2odt.py
        tools/rst2odt_prepstyles.py tools/rst2pseudoxml.py tools/rst2s5.py
        tools/rst2xetex.py tools/rst2xml.py tools/rstpep2html.py
        tools/dev/README.txt tools/dev/create_unimap.py
        tools/dev/generate_punctuation_chars.py tools/dev/profile_docutils.py
        tools/dev/unicode2rstsubs.py tools/editors/README.txt
        tools/editors/emacs/IDEAS.rst tools/editors/emacs/README.txt
        tools/editors/emacs/rst.el tools/editors/emacs/tests/Ado.el
        tools/editors/emacs/tests/Hdr.el tools/editors/emacs/tests/Makefile
        tools/editors/emacs/tests/README.txt tools/editors/emacs/tests/Stn.el
        ...
        tools/editors/emacs/tests/buffer.el tools/editors/emacs/tests/comment.el
        tools/editors/emacs/tests/ert-buffer.el
        tools/editors/emacs/tests/fill.el tools/editors/emacs/tests/font-lock.el
        tools/editors/emacs/tests/helpers.el tools/editors/emacs/tests/imenu.el
        tools/editors/emacs/tests/indent.el tools/editors/emacs/tests/init.el
        tools/editors/emacs/tests/items.el tools/editors/emacs/tests/movement.el
        tools/editors/emacs/tests/re.el tools/editors/emacs/tests/shift.el
        tools/editors/emacs/tests/toc.el tools/editors/emacs/tests/tree.el
    ...
    <div class="footer">
      ...
      Generated on: 2020-08-28 10:16 UTC. Generated by
      <a class="reference external" href="http://docutils.sourceforge.net/"
        >Docutils</a
      >
      from
      <a
