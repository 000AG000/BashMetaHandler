...
from ..lex import condense
from ..lex import lex
from ..node import CykNode
from ..parse.google import parse
from ..parse.identifiers import ArgumentIdentifier
from ..parse.identifiers import ArgumentItemIdentifier
from ..parse.identifiers import ArgumentTypeIdentifier
from ..parse.identifiers import ExceptionIdentifier
from ..parse.identifiers import ExceptionItemIdentifier
from ..parse.identifiers import Identifier
from ..parse.identifiers import NoqaIdentifier
...
class Docstring(BaseDocstring):
    ...
    def get_section(self, section):
        ...
        if section == Sections.SHORT_DESCRIPTION:
            ...
            raise Exception(f"Unsupported section type {section.name}")
    ...
    def get_types(self, section):
        ...
        if section == Sections.ARGUMENTS_SECTION:
            ...
            raise Exception(
                f"Section type {section.name} does not have types, "
    ...
    def get_items(self, section):
        ...
        if section == Sections.ARGUMENTS_SECTION:
            ...
            raise Exception(
                f"Section type {section.name} does not have items, "
                + "or is not yet supported."
            )
        return None
