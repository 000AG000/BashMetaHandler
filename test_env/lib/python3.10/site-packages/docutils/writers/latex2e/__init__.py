...
class Table:
    ...
    def get_colspecs(self, node):
        ...
        for node in self._col_specs:
            ...
            latex_table_spec += "{}p{{{:.3f}\\DUtablewidth}}".format(
                bar, colwidth + 0.005
            )
        return latex_table_spec + bar
...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def visit_footnote_reference(self, node):
        ...
        if format == "brackets":
            ...
            if not self.fallback_stylesheet:
                self.fallbacks["footnotes"] = PreambleCmds.footnotes
            self.out.append(
                r"\DUfootnotemark{{{}}}{{{}}}{{".format(node["ids"][0], href)
            )
            self.context.append("}")
    ...
    def visit_literal_block(self, node):
        ...
        if literal_env and _use_env and (not _autowidth_table or _use_listings):
            ...
            self.out.append(
                f"\\begin{{{literal_env}}}{self.literal_block_options}\n"
            )
            self.context.append("\n\\end{%s}" % literal_env)
    ...
    def visit_title(self, node):
        ...
        # Section title
            ...
            if "system-messages" in node.parent["classes"]:
                ...
                self.out.append(
                    fr"\{section_name}[{section_title}]{{\color{{red}}"
                )
            else:
    ...
    def minitoc(self, node, title, depth):
        ...
        # title:
        self.out.append(f"\\mtcsettitle{{{minitoc_name}toc}}{{{title}}}\n")
