...
def validate_encoding(
    ...
    try:
        ...
        raise LookupError('setting "{}": unknown encoding: "{}"'.format(setting, value))
    return value
...
def validate_strip_class(
    ...
    for cls in value:
        ...
        if cls != normalized:
            raise ValueError("Invalid class value {!r} (perhaps {!r}?)".format(cls, normalized))
    return value
...
class OptionParser(optparse.OptionParser, docutils.SettingsSpec):
    ...
    version_template = "%prog (Docutils {}{}, Python {}, on {})".format(
