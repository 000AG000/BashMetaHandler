...
class StateMachine:
    ...
    def error(self):
        ...
        print("{}: {}".format(type, value), file=self._stderr)
        print("input line %s" % (self.abs_line_number()), file=self._stderr)
        print(
            ("module {}, line {}, function {}".format(module, line, function)),
            file=self._stderr,
        )
...
class State:
    ...
    def make_transition(self, name, next_state=None):
        ...
        try:
            ...
            raise TransitionMethodNotFound("{}.{}".format(self.__class__.__name__, name))
