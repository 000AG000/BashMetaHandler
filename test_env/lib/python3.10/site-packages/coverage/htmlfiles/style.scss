...
$font-normal: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Ubuntu,
      ...
      &.show_mis .t {
        ...
        &:hover {
          ...
          @include background-dark(
            mix($dark-mis-bg, $dark-fg, $hover-dark-amt)
          );
        }
      }
    }
    ...
    &.run {
      ...
      &.show_run .t {
        ...
        &:hover {
          ...
          @include background-dark(
            mix($dark-run-bg, $dark-fg, $hover-dark-amt)
          );
        }
      }
    }
    ...
    &.exc {
      ...
      &.show_exc .t {
        ...
        &:hover {
          ...
          @include background-dark(
            mix($dark-exc-bg, $dark-fg, $hover-dark-amt)
          );
        }
      }
    }
    ...
    &.par {
      ...
      &.show_par .t {
        ...
        &:hover {
          ...
          @include background-dark(
            mix($dark-par-bg, $dark-fg, $hover-dark-amt)
          );
        }
      }
    }
