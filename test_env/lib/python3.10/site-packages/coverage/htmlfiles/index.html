    ...
    <main id="index">
      <table class="index" data-sortable>
        ...
        <tbody>
          ...
          <tr class="file">
            <td class="name left">
              <a href="{{file.html_filename}}">{{file.relative_filename}}</a>
            </td>
            ...
            {% endif %}
            <td class="right" data-ratio="{{file.nums.ratio_covered|pair}}">
        ...
        <tfoot>
          <tr class="total">
            ...
            {% endif %}
            <td class="right" data-ratio="{{totals.ratio_covered|pair}}">
