...
if platform.system() == "Windows":
    from ._windows import _configure_context
    from ._windows import _verify_peercerts_impl
elif platform.system() == "Darwin":
    from ._macos import _configure_context
    from ._macos import _verify_peercerts_impl
else:
    from ._openssl import _configure_context
    from ._openssl import _verify_peercerts_impl
