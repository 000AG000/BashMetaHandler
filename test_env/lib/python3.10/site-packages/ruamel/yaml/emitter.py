...
# fmt: off
from ruamel.yaml.compat import DBG_EVENT  # NOQA
from ruamel.yaml.compat import check_anchorname_char
from ruamel.yaml.compat import dbg
...
class Emitter:
    ...
    def __init__(
        ...
        self.no_newline: bool | None = None  # set if directly after `- `
    ...
    def expect_flow_mapping(
        ...
        force_flow_indent: bool | None = False,
    ) -> None:
        if force_flow_indent:
