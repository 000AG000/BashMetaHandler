...
from ruamel.yaml.resolver import Resolver  # NOQA
...
try:
    from _ruamel_yaml import CEmitter  # type: ignore
    from _ruamel_yaml import CParser
except:  # NOQA
...
class YAML:
    def __init__(
        ...
        *,
        ...
        self.scalar_after_indicator: bool | None = None
    ...
    def load_all(self, stream: Path | StreamTextType) -> Any:  # *, skip=None):
        if not hasattr(stream, "read") and hasattr(stream, "open"):
            # pathlib.Path() instance
            ...
            if self.Reader is not None:
                ...
                class XLoader(self.Parser, self.Constructor, rslvr):  # type: ignore
                    def __init__(
                        ...
                        version: VersionType | None = self.version,
