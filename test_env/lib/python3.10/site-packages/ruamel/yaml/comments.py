...
from ruamel.yaml.compat import MutableSliceableSequence  # NOQA
...
class CommentedSeq(MutableSliceableSequence, list, CommentedBase):  # type: ignore
    ...
    def _yaml_add_comment(self, comment: Any, key: Any | None = NotNone) -> None:
...
class CommentedMap(ordereddict, CommentedBase):
    ...
    def insert(
        self, pos: Any, key: Any, value: Any, comment: Any | None = None
    ) -> None:
...
class TaggedScalar(CommentedBase):
    ...
    def count(
        self, s: str, start: int | None = None, end: int | None = None
    ) -> Any:
