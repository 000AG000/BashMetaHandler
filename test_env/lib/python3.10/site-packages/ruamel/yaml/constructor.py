...
from ruamel.yaml.comments import C_KEY_EOL
from ruamel.yaml.comments import C_KEY_POST
from ruamel.yaml.comments import C_KEY_PRE
from ruamel.yaml.comments import C_VALUE_EOL
from ruamel.yaml.comments import C_VALUE_POST
from ruamel.yaml.comments import C_VALUE_PRE
from ruamel.yaml.comments import CommentedKeyMap
from ruamel.yaml.comments import CommentedKeySeq
...
from ruamel.yaml.compat import nprintf
from ruamel.yaml.compat import ordereddict
from ruamel.yaml.compat import version_tnf

# fmt: off
from ruamel.yaml.error import MantissaNoDotYAML1_1Warning
from ruamel.yaml.error import MarkedYAMLError
from ruamel.yaml.error import MarkedYAMLFutureWarning
...
from ruamel.yaml.util import create_timestamp
...
class BaseConstructor:
    ...
    def __init__(
        self, preserve_quotes: bool | None = None, loader: Any = None
    ) -> None:
        self.loader = loader
        if (
    ...
    def construct_non_recursive_object(
        self, node: Any, tag: str | None = None
    ) -> Any:
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_unknown(
        self,
        node: Any,
    ) -> Iterator[CommentedMap | TaggedScalar | CommentedSeq]:
        try:
            if isinstance(node, MappingNode):
                data = CommentedMap()
                data._yaml_set_line_col(node.start_mark.line, node.start_mark.column)
