...
class NotebookLoader:
    ...
    default_options = {"only_defs": False, "run_nbinit": True, "encoding": "utf-8"}
    ...
    def load_module(self, fullname=None, fpath=None):
        ...
        with open(fpath, encoding=self.options["encoding"]) as f:
...
def execute_notebook(ipynb_fpath, timeout=None, verbose=None):
    ...
    if verbose > 1:
        print(f"executing notebook in dpath = {dpath!r}")
