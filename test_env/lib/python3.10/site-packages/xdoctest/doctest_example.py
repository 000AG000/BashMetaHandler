...
class DocTest:
    ...
    def __nice__(self):
        ...
        parts.append("{}:{}".format(self.callname, self.num))
    ...
    def __repr__(self):
        ...
        return "<{}({}) at {}>".format(classname, devnice, hex(id(self)))
    ...
    def __str__(self):
        ...
        classname = self.__class__.__name__
        devnice = self.__nice__()
        return "<{}({})>".format(classname, devnice)
            ...
            for partx, part in enumerate(self._parts):
                ...
                # Handle anything that could go wrong
                    ...
                    if DEBUG:
                        ...
                        print(
                            f"found_lineno = {found_lineno!r}", file=sys.stderr
                        )
    ...
    def _print_captured(self):
        ...
        try:
            ...
            print("type(out_text) = {!r}".format(type(out_text)))
            print("out_text = {!r}".format(out_text))
