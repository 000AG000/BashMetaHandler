...
class DoctestPart:
    ...
    def __nice__(self):
        ...
        if self.source:
            ...
            parts.append('src="{}..."'.format(head_src))
        else:
            parts.append('src=""')
        ...
        if self.want is None:
            ...
            parts.append('want="{}..."'.format(head_wnt))
        return ", ".join(parts)
    ...
    def check(
        part, got_stdout, got_eval=constants.NOT_EVALED, runstate=None, unmatched=None
    ):
        r"""
    ...
    def format_part(
        ...
        if partnos:
            part_lines = [f"(p{self.partno}) {line}" for line in part_lines]
