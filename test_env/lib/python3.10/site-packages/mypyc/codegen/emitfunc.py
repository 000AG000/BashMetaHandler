...
from mypyc.codegen.emit import DEBUG_ERRORS
from mypyc.codegen.emit import Emitter
from mypyc.codegen.emit import TracebackAndGotoHandler
from mypyc.codegen.emit import c_array_initializer
from mypyc.common import MODULE_PREFIX
from mypyc.common import NATIVE_PREFIX
from mypyc.common import REG_PREFIX
from mypyc.common import STATIC_PREFIX
from mypyc.common import TYPE_PREFIX
from mypyc.ir.class_ir import ClassIR
from mypyc.ir.func_ir import FUNC_CLASSMETHOD
...
from mypyc.ir.ops import ControlOp
from mypyc.ir.ops import DecRef
...
from mypyc.ir.ops import InitStatic
...
from mypyc.ir.ops import LoadGlobal
...
from mypyc.ir.ops import OpVisitor
...
from mypyc.ir.rtypes import RStruct
...
from mypyc.ir.rtypes import is_pointer_rprimitive
...
class FunctionEmitterVisitor(OpVisitor[None]):
    ...
    def visit_float_op(self, op: FloatOp) -> None:
        ...
        if op.op != FloatOp.MOD:
            self.emit_line("{} = {} {} {};".format(dest, lhs, op.op_str[op.op], rhs))
        else:
            # TODO: This may set errno as a side effect, that is a little sketchy.
            self.emit_line("{} = fmod({}, {});".format(dest, lhs, rhs))
