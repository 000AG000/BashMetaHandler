...
from mypyc.irbuild.util import get_mypyc_attrs
from mypyc.irbuild.util import is_dataclass
from mypyc.irbuild.util import is_extension_class
from mypyc.irbuild.util import is_trait
