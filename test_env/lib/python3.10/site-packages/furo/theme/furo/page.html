{% extends "base.html" %} {% block body -%} {{ super() }} {% include
"partials/icons.html" %}
  ...
  <header class="mobile-header">
    ...
    <div class="header-center">
      <a href="{{ pathto(master_doc) }}"
        ><div class="brand">{{ docstitle if docstitle else project }}</div></a
      >
    </div>
    <div class="header-right">
      ...
      <label
        class="toc-overlay-icon toc-header-icon{% if furo_hide_toc %} no-toc{% endif %}"
        for="__toc"
      >
    ...
    <div class="content">
      <div class="article-container">
        ...
        <div class="content-icon-container">
          ...
          value for 'top_of_page_button'") }} {%- endif -%} {#- Theme toggle -#}
        ...
        <div class="bottom-of-page">
          <div class="left-details">
            ...
            <div class="copyright">
              ...
              Copyright &#169; {{ copyright }} {%- endtrans %} {%- endif %}
            </div>
            {%- endif %} {% trans %}Made with {% endtrans -%} {%- if show_sphinx
            -%} {% trans %}<a href="https://www.sphinx-doc.org/">Sphinx</a> and
            {% endtrans -%}
            <a class="muted-link" href="https://pradyunsg.me">@pradyunsg</a>'s
            {% endif -%} {% trans %}
            <a href="https://github.com/pradyunsg/furo">Furo</a>
            {% endtrans %} {%- if last_updated -%}
          ...
          <div class="right-details">
            <div class="icons">
              {% if theme_footer_icons -%} {% for icon_dict in
              theme_footer_icons -%}
              <a
              ...
              {% endfor %} {%- else -%} {#- Show Read the Docs project -#} {%-
              ...
              {%- endif -%} {#- Show GitHub repository home -#} {%- if
              READTHEDOCS and display_github and github_user != "None" and
              github_repo != "None" -%}
              <a
                class="muted-link"
